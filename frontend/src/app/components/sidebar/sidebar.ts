...
export class SidebarComponent {
    ...
    const sectionsStations: MenuSection[] = [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: 'date_range', label: 'الفترات المالية', route: `${b}/fiscal-periods` },
  ...
  private readonly iconColorMap: Record<string, [string, string]> = {
    ...
    label: ['#0ea5e9', '#38bdf8'],
    folder_open: ['#f59e0b', '#fbbf24'],
    date_range: ['#6366f1', '#818cf8'],
    swap_horiz: ['#14b8a6', '#2dd4bf'],
    dashboard_customize: ['#a855f7', '#c084fc'],
  };
  ...
  private appendArchiveMenuItem(sections: MenuSection[], bizId: number): MenuSection[] {
    ...
    return [...sections, { title: 'الأرشيف', items: [archiveItem] }];
  }
}
