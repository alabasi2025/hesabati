...
/**
 * بطاقة إحصائيات بتأثيرات CSS 3D.
...
@Component({
  ...
  styles: [`
    ...
    .shape-3 { width: 35px; height: 35px; top: 50%; right: 30%; animation: floatShape3 6s ease-in-out infinite; }
    ...
    .stat-card-3d.hovered .stat-icon-wrap { transform: scale(1.1) rotate(-5deg); }
    .stat-icon-wrap .material-icons-round { font-size: 26px; }
    .stat-info { display: flex; flex-direction: column; gap: 4px; }
    .stat-value { font-size: 1.6rem; font-weight: 700; color: #f1f5f9; letter-spacing: -0.02em; }
