...
// src/app/pages/journal-categories/journal-categories.ts
var _forTrack0 = ($index, $item) => $item.id;
function JournalCategoriesComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
...
function JournalCategoriesComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6, "\u0623\u0636\u0641 \u062A\u0635\u0646\u064A\u0641\u0627\u062A \u0644\u062A\u0646\u0638\u064A\u0645 \u0642\u064A\u0648\u062F \u0627\u0644\u064A\u0648\u0645\u064A\u0629 \u062D\u0633\u0628 \u0646\u0648\u0639\u0647\u0627");
    \u0275\u0275elementEnd()();
  }
}
function JournalCategoriesComponent_Conditional_21_For_2_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
...
function JournalCategoriesComponent_Conditional_21_For_2_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " \u0646\u0634\u0637 ");
  }
}
function JournalCategoriesComponent_Conditional_21_For_2_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " \u063A\u064A\u0631 \u0646\u0634\u0637 ");
  }
}
function JournalCategoriesComponent_Conditional_21_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function JournalCategoriesComponent_Conditional_21_For_2_Template_button_click_6_listener() {
    ...
    \u0275\u0275listener("click", function JournalCategoriesComponent_Conditional_21_For_2_Template_button_click_9_listener() {
      const c_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(16, JournalCategoriesComponent_Conditional_21_For_2_Conditional_16_Template, 2, 1, "p", 21);
    \u0275\u0275elementStart(17, "div", 22)(18, "span", 23);
    \u0275\u0275conditionalCreate(19, JournalCategoriesComponent_Conditional_21_For_2_Conditional_19_Template, 1, 0)(20, JournalCategoriesComponent_Conditional_21_For_2_Conditional_20_Template, 1, 0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(c_r3.icon || "book");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate(c_r3.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(c_r3.categoryKey);
    \u0275\u0275advance();
    \u0275\u0275conditional(c_r3.description ? 16 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("background", c_r3.color + "15")("color", c_r3.color);
    \u0275\u0275advance();
    \u0275\u0275conditional(c_r3.isActive ? 19 : 20);
  }
}
function JournalCategoriesComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10);
    \u0275\u0275repeaterCreate(1, JournalCategoriesComponent_Conditional_21_For_2_Template, 21, 13, "div", 13, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function JournalCategoriesComponent_Conditional_22_For_47_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 45);
    \u0275\u0275listener("click", function JournalCategoriesComponent_Conditional_22_For_47_Template_button_click_0_listener() {
...
function JournalCategoriesComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275listener("click", function JournalCategoriesComponent_Conditional_22_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.showForm.set(false));
    });
    \u0275\u0275elementStart(1, "div", 25);
    \u0275\u0275listener("click", function JournalCategoriesComponent_Conditional_22_Template_div_click_1_listener($event) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "p");
    \u0275\u0275text(11, "\u062A\u0635\u0646\u064A\u0641\u0627\u062A \u0642\u064A\u0648\u062F \u0627\u0644\u064A\u0648\u0645\u064A\u0629 \u062A\u0633\u0627\u0639\u062F \u0641\u064A \u062A\u0646\u0638\u064A\u0645 \u0627\u0644\u0642\u064A\u0648\u062F \u0627\u0644\u0645\u062D\u0627\u0633\u0628\u064A\u0629");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "button", 29);
    \u0275\u0275listener("click", function JournalCategoriesComponent_Conditional_22_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.showForm.set(false));
    });
    ...
    \u0275\u0275twoWayListener("ngModelChange", function JournalCategoriesComponent_Conditional_22_Template_input_ngModelChange_22_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function JournalCategoriesComponent_Conditional_22_Template_input_ngModelChange_28_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function JournalCategoriesComponent_Conditional_22_Template_textarea_ngModelChange_32_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function JournalCategoriesComponent_Conditional_22_Template_input_ngModelChange_38_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275repeaterCreate(46, JournalCategoriesComponent_Conditional_22_For_47_Template, 3, 5, "button", 41, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(48, "div", 42)(49, "button", 43);
    \u0275\u0275listener("click", function JournalCategoriesComponent_Conditional_22_Template_button_click_49_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function JournalCategoriesComponent_Conditional_22_Template_button_click_51_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.showForm.set(false));
    });
...
var JournalCategoriesComponent = class _JournalCategoriesComponent extends BasePageComponent {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275JournalCategoriesComponent_BaseFactory;
    return function JournalCategoriesComponent_Factory(__ngFactoryType__) {
      return (\u0275JournalCategoriesComponent_BaseFactory || (\u0275JournalCategoriesComponent_BaseFactory = \u0275\u0275getInheritedFactory(_JournalCategoriesComponent)))(__ngFactoryType__ || _JournalCategoriesComponent);
    };
  })();
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _JournalCategoriesComponent, selectors: [["app-journal-categories"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 23, vars: 3, consts: [[1, "page-content"], [1, "page-header"], [1, "material-icons-round"], [1, "add-btn", 3, "click"], [1, "summary-row"], [1, "summary-card", "indigo"], [1, "num"], [1, "lbl"], [3, "loading"], [1, "empty-state"], [1, "categories-grid"], [1, "modal-overlay"], [1, "empty-hint"], [1, "category-card"], [1, "cat-header"], [1, "cat-icon"], [1, "cat-actions"], [1, "action-btn", "edit", 3, "click"], [1, "action-btn", "delete", 3, "click"], [1, "cat-name"], [1, "cat-key"], [1, "cat-desc"], [1, "cat-footer"], [1, "cat-badge"], [1, "modal-overlay", 3, "click"], [1, "modal-card", 3, "click"], [1, "modal-header"], [1, "modal-title-row"], [1, "modal-icon", "indigo"], [1, "close-btn", 3, "click"], [1, "modal-body"], [1, "form-row"], [1, "form-group"], [1, "required"], ["placeholder", "\u0645\u062B\u0627\u0644: \u0645\u0635\u0631\u0648\u0641\u0627\u062A \u062A\u0634\u063A\u064A\u0644\u064A\u0629", 3, "ngModelChange", "ngModel"], ["placeholder", "\u0645\u062B\u0627\u0644: operational_expenses", "dir", "ltr", 3, "ngModelChange", "ngModel"], ["rows", "2", "placeholder", "\u0648\u0635\u0641 \u0645\u062E\u062A\u0635\u0631 \u0644\u0644\u062A\u0635\u0646\u064A\u0641...", 3, "ngModelChange", "ngModel"], [1, "color-picker-row"], ["type", "color", 3, "ngModelChange", "ngModel"], [1, "color-preview"], [1, "icon-grid"], [1, "icon-btn", 3, "selected", "color"], [1, "modal-footer"], [1, "btn-save", 3, "click"], [1, "btn-cancel", 3, "click"], [1, "icon-btn", 3, "click"]], template: function JournalCategoriesComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h2")(3, "span", 2);
      \u0275\u0275text(4, "category");
      \u0275\u0275elementEnd();
      \u0275\u0275text(5, " \u062A\u0635\u0646\u064A\u0641\u0627\u062A \u0642\u064A\u0648\u062F \u0627\u0644\u064A\u0648\u0645\u064A\u0629");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "button", 3);
      \u0275\u0275listener("click", function JournalCategoriesComponent_Template_button_click_6_listener() {
        return ctx.openAdd();
      });
      \u0275\u0275elementStart(7, "span", 2);
      \u0275\u0275text(8, "add");
      ...
      \u0275\u0275elementEnd()()()();
      \u0275\u0275conditionalCreate(19, JournalCategoriesComponent_Conditional_19_Template, 1, 1, "app-loading-state", 8)(20, JournalCategoriesComponent_Conditional_20_Template, 7, 0, "div", 9)(21, JournalCategoriesComponent_Conditional_21_Template, 3, 0, "div", 10);
      \u0275\u0275conditionalCreate(22, JournalCategoriesComponent_Conditional_22_Template, 53, 9, "div", 11);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(16);
...
\r
  @if (loading()) {\r
    ...
    <div class="empty-state">\r
      ...
      <p class="empty-hint">\u0623\u0636\u0641 \u062A\u0635\u0646\u064A\u0641\u0627\u062A \u0644\u062A\u0646\u0638\u064A\u0645 \u0642\u064A\u0648\u062F \u0627\u0644\u064A\u0648\u0645\u064A\u0629 \u062D\u0633\u0628 \u0646\u0648\u0639\u0647\u0627</p>\r
    </div>\r
  } @else {\r
        ...
        <div class="category-card">\r
          <div class="cat-header">\r
            <div class="cat-icon" [style.background]="c.color + '18'" [style.color]="c.color">\r
              <span class="material-icons-round">{{ c.icon || 'book' }}</span>\r
            </div>\r
        ...
        <div class="modal-header">\r
          <div class="modal-title-row">\r
            ...
            <div>\r
              ...
              <p>\u062A\u0635\u0646\u064A\u0641\u0627\u062A \u0642\u064A\u0648\u062F \u0627\u0644\u064A\u0648\u0645\u064A\u0629 \u062A\u0633\u0627\u0639\u062F \u0641\u064A \u062A\u0646\u0638\u064A\u0645 \u0627\u0644\u0642\u064A\u0648\u062F \u0627\u0644\u0645\u062D\u0627\u0633\u0628\u064A\u0629</p>\r
            </div>\r
          </div>\r
        ...
        <div class="modal-body">\r
          <div class="form-row">\r
            <div class="form-group">\r
              ...
              <input [(ngModel)]="form.name" placeholder="\u0645\u062B\u0627\u0644: \u0645\u0635\u0631\u0648\u0641\u0627\u062A \u062A\u0634\u063A\u064A\u0644\u064A\u0629" />\r
            </div>\r
            <div class="form-group">\r
              <label>\u0627\u0644\u0645\u0641\u062A\u0627\u062D <span class="required">*</span></label>\r
              <input [(ngModel)]="form.categoryKey" placeholder="\u0645\u062B\u0627\u0644: operational_expenses" dir="ltr" />\r
            </div>\r
          </div>\r
          <div class="form-group">\r
            <label>\u0627\u0644\u0648\u0635\u0641</label>\r
