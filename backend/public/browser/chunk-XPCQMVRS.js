...
// src/app/pages/exchanges/exchanges.ts
var _c0 = () => ["#4CAF50", "#2196F3", "#FF9800", "#9C27B0", "#607D8B", "#E91E63", "#00BCD4", "#F44336", "#795548", "#3F51B5"];
var _forTrack0 = ($index, $item) => $item.value;
var _forTrack1 = ($index, $item) => $item.id;
function ExchangesComponent_For_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 19);
    \u0275\u0275listener("click", function ExchangesComponent_For_22_Template_button_click_0_listener() {
...
function ExchangesComponent_For_30_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ExchangesComponent_For_30_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 23)(1, "span", 4);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ExchangesComponent_For_30_Conditional_3_Template, 2, 5, "span", 24);
    ...
    \u0275\u0275listener("click", function ExchangesComponent_For_30_Template_button_click_8_listener() {
    ...
    \u0275\u0275listener("click", function ExchangesComponent_For_30_Template_button_click_11_listener() {
      const t_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
...
function ExchangesComponent_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
...
function ExchangesComponent_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
    \u0275\u0275text(4, "\u0644\u0627 \u064A\u0648\u062C\u062F \u0635\u0631\u0627\u0641\u064A\u0646");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 31);
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_32_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
...
function ExchangesComponent_Conditional_33_For_2_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
...
function ExchangesComponent_Conditional_33_For_2_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
...
function ExchangesComponent_Conditional_33_For_2_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
...
function ExchangesComponent_Conditional_33_For_2_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 44)(1, "span", 4);
    \u0275\u0275text(2, "storefront");
    \u0275\u0275elementEnd();
...
function ExchangesComponent_Conditional_33_For_2_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 44)(1, "span", 4);
    \u0275\u0275text(2, "person");
    \u0275\u0275elementEnd();
...
function ExchangesComponent_Conditional_33_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_33_For_2_Template_button_click_6_listener() {
    ...
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_33_For_2_Template_button_click_9_listener() {
      const acc_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(17, ExchangesComponent_Conditional_33_For_2_Conditional_17_Template, 2, 1, "span", 42);
    \u0275\u0275conditionalCreate(18, ExchangesComponent_Conditional_33_For_2_Conditional_18_Template, 2, 1, "span", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(19, ExchangesComponent_Conditional_33_For_2_Conditional_19_Template, 4, 1, "div", 44);
    \u0275\u0275conditionalCreate(20, ExchangesComponent_Conditional_33_For_2_Conditional_20_Template, 4, 1, "div", 44);
    \u0275\u0275conditionalCreate(21, ExchangesComponent_Conditional_33_For_2_Conditional_21_Template, 4, 1, "div", 44);
...
function ExchangesComponent_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275repeaterCreate(1, ExchangesComponent_Conditional_33_For_2_Template, 30, 20, "div", 32, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function ExchangesComponent_Conditional_34_For_26_Template(rf, ctx) {
  if (rf & 1) {
...
function ExchangesComponent_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 49);
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_34_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showAccountForm.set(false));
    });
    \u0275\u0275elementStart(1, "div", 50);
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_34_Template_div_click_1_listener($event) {
      return $event.stopPropagation();
    });
    \u0275\u0275elementStart(2, "div", 51)(3, "div", 52)(4, "div", 53)(5, "span", 4);
    \u0275\u0275text(6, "currency_exchange");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_34_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showAccountForm.set(false));
    });
    ...
    \u0275\u0275text(19, "\u0627\u0633\u0645 \u0627\u0644\u0635\u0631\u0627\u0641");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "input", 58);
    \u0275\u0275twoWayListener("ngModelChange", function ExchangesComponent_Conditional_34_Template_input_ngModelChange_20_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ExchangesComponent_Conditional_34_Template_select_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.accountForm.subType, $event) || (ctx_r2.accountForm.subType = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275repeaterCreate(25, ExchangesComponent_Conditional_34_For_26_Template, 2, 2, "option", 60, _forTrack1);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(27, "div", 56)(28, "div", 57)(29, "label");
    \u0275\u0275text(30, "\u0631\u0642\u0645 \u0627\u0644\u062D\u0633\u0627\u0628");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "input", 61);
    \u0275\u0275twoWayListener("ngModelChange", function ExchangesComponent_Conditional_34_Template_input_ngModelChange_31_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(34, "\u0634\u0631\u0643\u0629 \u0627\u0644\u0635\u0631\u0627\u0641\u0629");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "input", 62);
    \u0275\u0275twoWayListener("ngModelChange", function ExchangesComponent_Conditional_34_Template_input_ngModelChange_35_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ExchangesComponent_Conditional_34_Template_input_ngModelChange_40_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ExchangesComponent_Conditional_34_Template_textarea_ngModelChange_44_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_34_Template_button_click_46_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_34_Template_button_click_50_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showAccountForm.set(false));
    });
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate(ctx_r2.editingAccountId() ? "\u062A\u0639\u062F\u064A\u0644 \u0635\u0631\u0627\u0641" : "\u0625\u0636\u0627\u0641\u0629 \u0635\u0631\u0627\u0641 \u062C\u062F\u064A\u062F");
    \u0275\u0275advance(11);
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.accountForm.name);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.accountForm.subType);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.exchangeTypes());
    \u0275\u0275advance(6);
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.editingAccountId() ? "\u062D\u0641\u0638 \u0627\u0644\u062A\u0639\u062F\u064A\u0644\u0627\u062A" : "\u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0635\u0631\u0627\u0641");
  }
}
function ExchangesComponent_Conditional_35_For_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 75);
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_35_For_34_Template_button_click_0_listener() {
...
function ExchangesComponent_Conditional_35_For_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 76);
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_35_For_40_Template_button_click_0_listener() {
...
function ExchangesComponent_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 49);
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_35_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showTypeForm.set(false));
    });
    \u0275\u0275elementStart(1, "div", 50);
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_35_Template_div_click_1_listener($event) {
      return $event.stopPropagation();
    });
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "p");
    \u0275\u0275text(11, "\u062A\u0635\u0646\u064A\u0641\u0627\u062A \u0627\u0644\u0635\u0631\u0627\u0641\u064A\u0646 \u062A\u0638\u0647\u0631 \u0643\u0641\u0644\u0627\u062A\u0631 \u0641\u0631\u0639\u064A\u0629");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "button", 54);
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_35_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showTypeForm.set(false));
    });
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ExchangesComponent_Conditional_35_Template_input_ngModelChange_20_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ExchangesComponent_Conditional_35_Template_input_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ExchangesComponent_Conditional_35_Template_textarea_ngModelChange_28_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275repeaterCreate(33, ExchangesComponent_Conditional_35_For_34_Template, 3, 3, "button", 72, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "div", 57)(36, "label");
    \u0275\u0275text(37, "\u0627\u0644\u0644\u0648\u0646");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "div", 73);
    \u0275\u0275repeaterCreate(39, ExchangesComponent_Conditional_35_For_40_Template, 1, 4, "button", 74, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(41, "div", 65)(42, "button", 66);
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_35_Template_button_click_42_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_35_Template_button_click_46_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showTypeForm.set(false));
    });
...
function ExchangesComponent_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 49);
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_36_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r16);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showDeleteConfirm.set(false));
    });
    \u0275\u0275elementStart(1, "div", 77);
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_36_Template_div_click_1_listener($event) {
      return $event.stopPropagation();
    });
    ...
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_36_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r16);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showDeleteConfirm.set(false));
    });
    ...
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_36_Template_button_click_21_listener() {
      \u0275\u0275restoreView(_r16);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ExchangesComponent_Conditional_36_Template_button_click_25_listener() {
      \u0275\u0275restoreView(_r16);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showDeleteConfirm.set(false));
    });
...
var ExchangesComponent = class _ExchangesComponent extends BasePageComponent {
  ...
  typeForm = { name: "", subTypeKey: "", description: "", icon: "currency_exchange", color: "#FF9800" };
  ...
  async load() {
    ...
    try {
      ...
      this.accounts.set(accs.filter((a) => a.accountType === "exchange"));
  ...
  async saveAccount() {
    try {
      const exchangeSubNatureId = this.accountSubNatures().find((n) => n.natureKey === "exchange")?.id;
      ...
      const validSubType = this.exchangeTypes().some((t) => String(t.subTypeKey) === selectedSubType);
      if (!selectedSubType || !validSubType) {
        this.toast.error("\u0627\u062E\u062A\u064A\u0627\u0631 \u062A\u0635\u0646\u064A\u0641 \u0635\u0631\u0627\u0641 \u0635\u062D\u064A\u062D \u0625\u0644\u0632\u0627\u0645\u064A \u0642\u0628\u0644 \u0627\u0644\u062D\u0641\u0638.");
        return;
      }
      const data = __spreadProps(__spreadValues({}, this.accountForm), { accountType: "exchange", accountSubNatureId: exchangeSubNatureId, isLeafAccount: true });
  ...
  async executeDelete() {
    ...
    try {
      if (target.type === "account")
        ...
        await this.api.deleteExchangeType(target.id);
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275ExchangesComponent_BaseFactory;
    return function ExchangesComponent_Factory(__ngFactoryType__) {
      return (\u0275ExchangesComponent_BaseFactory || (\u0275ExchangesComponent_BaseFactory = \u0275\u0275getInheritedFactory(_ExchangesComponent)))(__ngFactoryType__ || _ExchangesComponent);
    };
  })();
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExchangesComponent, selectors: [["app-exchanges"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 37, vars: 6, consts: [[1, "page-content"], [1, "page-header"], [1, "page-title-area"], [1, "page-icon", "amber"], [1, "material-icons-round"], [1, "page-subtitle"], [1, "header-actions"], [1, "add-btn", "secondary", 3, "click"], [1, "add-btn", 3, "click"], [1, "filter-tabs"], [1, "filter-tab", 3, "active"], [1, "types-bar"], [1, "types-bar-title"], [1, "types-list"], [1, "type-chip", 3, "border-color"], [1, "loading-state"], [1, "empty-state"], [1, "accounts-grid"], [1, "modal-overlay"], [1, "filter-tab", 3, "click"], [1, "material-icons-round", "tab-icon"], [1, "tab-label"], [1, "tab-count"], [1, "type-chip"], [1, "type-chip-seq", 3, "background", "color"], [1, "type-chip-name"], [1, "type-chip-key"], [1, "chip-action", 3, "click"], [1, "chip-action", "delete", 3, "click"], [1, "type-chip-seq"], [1, "material-icons-round", "spin"], [1, "add-btn", "small", 3, "click"], [1, "account-card", 3, "border-right-color"], [1, "account-card"], [1, "card-header"], [1, "card-icon"], [1, "card-actions"], [1, "action-btn", "edit", 3, "click"], [1, "action-btn", "delete", 3, "click"], [1, "card-name"], [1, "card-badges"], [1, "card-type-badge"], [1, "card-seq-badge"], [1, "card-code-badge"], [1, "card-detail"], [1, "card-balance"], [1, "balance-text"], [1, "card-status"], [1, "status-dot"], [1, "modal-overlay", 3, "click"], [1, "modal-card", 3, "click"], [1, "modal-header"], [1, "modal-title-row"], [1, "modal-icon", "amber"], [1, "close-btn", 3, "click"], [1, "modal-body"], [1, "form-row"], [1, "form-group"], ["placeholder", "\u0645\u062B\u0627\u0644: \u0627\u0644\u0646\u0647\u0645\u064A - \u062D\u0633\u0627\u0628 1", 3, "ngModelChange", "ngModel"], [3, "ngModelChange", "ngModel"], [3, "value"], ["placeholder", "\u0631\u0642\u0645 \u0627\u0644\u062D\u0633\u0627\u0628", "dir", "ltr", 3, "ngModelChange", "ngModel"], ["placeholder", "\u0627\u0633\u0645 \u0627\u0644\u0634\u0631\u0643\u0629", 3, "ngModelChange", "ngModel"], ["placeholder", "\u0627\u0633\u0645 \u0627\u0644\u0645\u0633\u0624\u0648\u0644", 3, "ngModelChange", "ngModel"], ["rows", "2", 3, "ngModelChange", "ngModel"], [1, "modal-footer"], [1, "btn-save", 3, "click"], [1, "btn-cancel", 3, "click"], [1, "modal-icon", "purple"], ["placeholder", "\u0645\u062B\u0627\u0644: \u0635\u0631\u0627\u0641\u0629 \u0645\u062D\u0644\u064A\u0629", 3, "ngModelChange", "ngModel"], ["placeholder", "\u0645\u062B\u0627\u0644: local", "dir", "ltr", 3, "ngModelChange", "ngModel"], [1, "icon-picker"], [1, "icon-option", 3, "selected"], [1, "color-picker"], [1, "color-option", 3, "background", "selected"], [1, "icon-option", 3, "click"], [1, "color-option", 3, "click"], [1, "modal-card", "small", 3, "click"], [1, "modal-icon", "red"], [1, "delete-msg"], [1, "delete-warn"], [1, "btn-delete", 3, "click"]], template: function ExchangesComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "div", 3)(4, "span", 4);
      \u0275\u0275text(5, "currency_exchange");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "div")(7, "h2");
      \u0275\u0275text(8, "\u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0635\u0631\u0627\u0641\u064A\u0646");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "p", 5);
      \u0275\u0275text(10);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(11, "div", 6)(12, "button", 7);
      \u0275\u0275listener("click", function ExchangesComponent_Template_button_click_12_listener() {
      ...
      \u0275\u0275listener("click", function ExchangesComponent_Template_button_click_16_listener() {
      ...
      \u0275\u0275repeaterCreate(21, ExchangesComponent_For_22_Template, 7, 5, "button", 10, _forTrack0);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275repeaterCreate(29, ExchangesComponent_For_30_Template, 14, 8, "div", 14, _forTrack1);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(31, ExchangesComponent_Conditional_31_Template, 5, 0, "div", 15)(32, ExchangesComponent_Conditional_32_Template, 9, 0, "div", 16)(33, ExchangesComponent_Conditional_33_Template, 3, 0, "div", 17);
      \u0275\u0275conditionalCreate(34, ExchangesComponent_Conditional_34_Template, 52, 9, "div", 18);
      \u0275\u0275conditionalCreate(35, ExchangesComponent_Conditional_35_Template, 48, 7, "div", 18);
      \u0275\u0275conditionalCreate(36, ExchangesComponent_Conditional_36_Template, 27, 1, "div", 18);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(10);
      \u0275\u0275textInterpolate2("", ctx.accounts().length, " \u0635\u0631\u0627\u0641 \u0641\u064A ", ctx.exchangeTypes().length, " \u062A\u0635\u0646\u064A\u0641");
      \u0275\u0275advance(11);
      \u0275\u0275repeater(ctx.getFilterTabs());
      \u0275\u0275advance(8);
      \u0275\u0275repeater(ctx.exchangeTypes());
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ExchangesComponent, [{
    type: Component,
    args: [{ selector: "app-exchanges", standalone: true, imports: [CommonModule, FormsModule, LoadingStateComponent, EmptyStateComponent, StatusBadgeComponent], template: `<div class="page-content">\r
  <div class="page-header">\r
    <div class="page-title-area">\r
      <div class="page-icon amber"><span class="material-icons-round">currency_exchange</span></div>\r
      <div>\r
        <h2>\u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0635\u0631\u0627\u0641\u064A\u0646</h2>\r
        <p class="page-subtitle">{{ accounts().length }} \u0635\u0631\u0627\u0641 \u0641\u064A {{ exchangeTypes().length }} \u062A\u0635\u0646\u064A\u0641</p>\r
      </div>\r
    </div>\r
    <div class="header-actions">\r
      ...
      <button class="add-btn" (click)="openAddAccount()"><span class="material-icons-round">add</span> \u0635\u0631\u0627\u0641 \u062C\u062F\u064A\u062F</button>\r
    </div>\r
  </div>\r
\r
...
\r
  <div class="types-bar">\r
    ...
    <div class="types-list">\r
      @for (t of exchangeTypes(); track t.id) {\r
...
\r
  @if (loading()) {\r
    ...
    <div class="empty-state"><span class="material-icons-round">currency_exchange</span><p>\u0644\u0627 \u064A\u0648\u062C\u062F \u0635\u0631\u0627\u0641\u064A\u0646</p>\r
      <button class="add-btn small" (click)="openAddAccount()"><span class="material-icons-round">add</span> \u0625\u0636\u0627\u0641\u0629 \u0635\u0631\u0627\u0641</button>\r
    </div>\r
  } @else {\r
    <div class="accounts-grid">\r
      @for (acc of filteredAccounts(); track acc.id) {\r
        <div class="account-card" [style.border-right-color]="getTypeInfo(acc.subType).color">\r
          ...
          @if (acc.provider) { <div class="card-detail"><span class="material-icons-round">storefront</span> {{ acc.provider }}</div> }\r
      ...
      <div class="modal-card" (click)="$event.stopPropagation()">\r
        <div class="modal-header">\r
          <div class="modal-title-row">\r
            <div class="modal-icon amber"><span class="material-icons-round">currency_exchange</span></div>\r
            <div><h2>{{ editingAccountId() ? '\u062A\u0639\u062F\u064A\u0644 \u0635\u0631\u0627\u0641' : '\u0625\u0636\u0627\u0641\u0629 \u0635\u0631\u0627\u0641 \u062C\u062F\u064A\u062F' }}</h2><p>\u0633\u064A\u0638\u0647\u0631 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B \u0641\u064A \u0635\u0641\u062D\u0629 \u0627\u0644\u062D\u0633\u0627\u0628\u0627\u062A</p></div>\r
          </div>\r
          <button class="close-btn" (click)="showAccountForm.set(false)"><span class="material-icons-round">close</span></button>\r
        </div>\r
        <div class="modal-body">\r
          <div class="form-row">\r
            <div class="form-group"><label>\u0627\u0633\u0645 \u0627\u0644\u0635\u0631\u0627\u0641</label><input [(ngModel)]="accountForm.name" placeholder="\u0645\u062B\u0627\u0644: \u0627\u0644\u0646\u0647\u0645\u064A - \u062D\u0633\u0627\u0628 1" /></div>\r
            <div class="form-group"><label>\u0627\u0644\u062A\u0635\u0646\u064A\u0641</label>\r
              <select [(ngModel)]="accountForm.subType">\r
                @for (t of exchangeTypes(); track t.id) { <option [value]="t.subTypeKey">{{ t.name }}</option> }\r
              </select>\r
            </div>\r
          </div>\r
          <div class="form-row">\r
            <div class="form-group"><label>\u0631\u0642\u0645 \u0627\u0644\u062D\u0633\u0627\u0628</label><input [(ngModel)]="accountForm.accountNumber" placeholder="\u0631\u0642\u0645 \u0627\u0644\u062D\u0633\u0627\u0628" dir="ltr" /></div>\r
            <div class="form-group"><label>\u0634\u0631\u0643\u0629 \u0627\u0644\u0635\u0631\u0627\u0641\u0629</label><input [(ngModel)]="accountForm.provider" placeholder="\u0627\u0633\u0645 \u0627\u0644\u0634\u0631\u0643\u0629" /></div>\r
          </div>\r
          <div class="form-row">\r
        ...
        <div class="modal-footer">\r
          <button class="btn-save" (click)="saveAccount()"><span class="material-icons-round">{{ editingAccountId() ? 'save' : 'add' }}</span> {{ editingAccountId() ? '\u062D\u0641\u0638 \u0627\u0644\u062A\u0639\u062F\u064A\u0644\u0627\u062A' : '\u0625\u0636\u0627\u0641\u0629 \u0627\u0644\u0635\u0631\u0627\u0641' }}</button>\r
...
\r
  @if (showTypeForm()) {\r
    <div class="modal-overlay" (click)="showTypeForm.set(false)">\r
      <div class="modal-card" (click)="$event.stopPropagation()">\r
        <div class="modal-header">\r
          <div class="modal-title-row"><div class="modal-icon purple"><span class="material-icons-round">category</span></div><div><h2>{{ editingTypeId() ? '\u062A\u0639\u062F\u064A\u0644 \u062A\u0635\u0646\u064A\u0641' : '\u0625\u0636\u0627\u0641\u0629 \u062A\u0635\u0646\u064A\u0641 \u062C\u062F\u064A\u062F' }}</h2><p>\u062A\u0635\u0646\u064A\u0641\u0627\u062A \u0627\u0644\u0635\u0631\u0627\u0641\u064A\u0646 \u062A\u0638\u0647\u0631 \u0643\u0641\u0644\u0627\u062A\u0631 \u0641\u0631\u0639\u064A\u0629</p></div></div>\r
          <button class="close-btn" (click)="showTypeForm.set(false)"><span class="material-icons-round">close</span></button>\r
        </div>\r
        <div class="modal-body">\r
          <div class="form-row">\r
            <div class="form-group"><label>\u0627\u0633\u0645 \u0627\u0644\u062A\u0635\u0646\u064A\u0641</label><input [(ngModel)]="typeForm.name" placeholder="\u0645\u062B\u0627\u0644: \u0635\u0631\u0627\u0641\u0629 \u0645\u062D\u0644\u064A\u0629" /></div>\r
