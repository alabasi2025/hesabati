...
piActionsRoutes.put(
  ...
  safeHandler(
    "طھط¹ط¯ظٹظ„ ظپط§طھظˆط±ط© ظ…ط´طھط±ظٹط§طھ",
    async (c: AppContext) => {
      const bizId = getBizId(c);
      const id = parseId(c.req.param("id"));
      if (!id)
        return c.json(
          { error: "ظ…ط¹ط±ظ‘ظپ ط§ظ„ظپط§طھظˆط±ط© ط؛ظٹط± طµط§ظ„ط­" },
          400,
        );
      ...
      if (existing.status === "completed" || existing.status === "cancelled") {
        return c.json(
          {
            error:
              "ظ„ط§ ظٹظ…ظƒظ† طھط¹ط¯ظٹظ„ ظپط§طھظˆط±ط© ظ…ظƒطھظ…ظ„ط© ط£ظˆ ظ…ظ„ط؛ط§ط©",
          },
          400,
        );
      }
...
piActionsRoutes.post(
  ...
  checkPermission("purchase_invoices", "update"),
  safeHandler(
    "طھط£ظƒظٹط¯ ظپط§طھظˆط±ط© ظ…ط´طھط±ظٹط§طھ",
    async (c: AppContext) => {
      const bizId = getBizId(c);
      ...
      const supplierAccountId =
        existing.supplierAccountId || supplier?.accountId || null;
...
piActionsRoutes.post(
  ...
  checkPermission("purchase_invoices", "update"),
  safeHandler(
    "ط§ط³طھظ„ط§ظ… ط¨ط¶ط§ط¦ط¹ ظپط§طھظˆط±ط© ظ…ط´طھط±ظٹط§طھ",
    async (c: AppContext) => {
      const bizId = getBizId(c);
      const id = parseId(c.req.param("id"));
      if (!id)
...
piActionsRoutes.delete(
  ...
  safeHandler("ط­ط°ظپ ظپط§طھظˆط±ط© ظ…ط´طھط±ظٹط§طھ", async (c: AppContext) => {
    ...
    if (existing.status === "completed") {
      return c.json(
        { error: "ظ„ط§ ظٹظ…ظƒظ† ط­ط°ظپ ظپط§طھظˆط±ط© ظ…ظƒطھظ…ظ„ط©" },
        400,
      );
    }
