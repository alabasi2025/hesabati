...
warehouseOpsReadRoutes.get(
  "/warehouse-operations/:id",
  safeHandler("ط¬ظ„ط¨ طھظپط§طµظٹظ„ ط¹ظ…ظ„ظٹط© ظ…ط®ط²ظ†ظٹط©", async (c) => {
    const id = parseId(c.req.param("id"));
    if (!id)
      return c.json(
        { error: "ظ…ط¹ط±ظ‘ظپ ط§ظ„ط¹ظ…ظ„ظٹط© ط؛ظٹط± طµط§ظ„ط­" },
        400,
      );
    ...
    if (!operation)
      return c.json(
        { error: "ط§ظ„ط¹ظ…ظ„ظٹط© ط§ظ„ظ…ط®ط²ظ†ظٹط© ط؛ظٹط± ظ…ظˆط¬ظˆط¯ط©" },
        404,
      );
...
warehouseOpsReadRoutes.get(
  ...
  bizAuthMiddleware(),
  safeHandler("ط¬ظ„ط¨ ظ…ط®ط²ظˆظ† ط§ظ„ظ…ط®ط²ظ†", async (c) => {
...
warehouseOpsReadRoutes.get(
  ...
  bizAuthMiddleware(),
  safeHandler("ط¬ظ„ط¨ ظƒظ„ ط§ظ„ط¹ظ…ظ„ظٹط§طھ ط§ظ„ظ…ط®ط²ظ†ظٹط©", async (c) => {
    const bizId = getBizId(c);
...
warehouseOpsReadRoutes.get(
  ...
  bizAuthMiddleware(),
  safeHandler("ظ…ظ„ط®طµ ظ…ط®ط²ظˆظ† ط¹ط¯ط© ظ…ط®ط§ط²ظ†", async (c) => {
    const bizId = getBizId(c);
    const warehouseIdsParam = c.req.query("warehouseIds");
    if (!warehouseIdsParam)
      return c.json({ error: "ظٹط¬ط¨ طھط­ط¯ظٹط¯ ط§ظ„ظ…ط®ط§ط²ظ†" }, 400);
    ...
    if (warehouseIds.length === 0)
      return c.json(
        { error: "ظ…ط¹ط±ظ‘ظپط§طھ ط§ظ„ظ…ط®ط§ط²ظ† ط؛ظٹط± طµط§ظ„ط­ط©" },
        400,
      );
...
warehouseOpsReadRoutes.get(
  ...
  bizAuthMiddleware(),
  safeHandler("ظ…ظ„ط®طµ ط§ظ„ط¹ظ…ظ„ظٹط§طھ ط§ظ„ظ…ط®ط²ظ†ظٹط©", async (c) => {
    const bizId = getBizId(c);
    ...
    if (from && !dateRegex.test(from))
      return c.json(
        {
          error:
            "طھظ†ط³ظٹظ‚ طھط§ط±ظٹط® ط§ظ„ط¨ط¯ط§ظٹط© ط؛ظٹط± طµط§ظ„ط­ (YYYY-MM-DD)",
        },
        400,
      );
    if (to && !dateRegex.test(to))
      return c.json(
        {
          error:
            "طھظ†ط³ظٹظ‚ طھط§ط±ظٹط® ط§ظ„ظ†ظ‡ط§ظٹط© ط؛ظٹط± طµط§ظ„ط­ (YYYY-MM-DD)",
        },
        400,
      );
    let query = sql`
