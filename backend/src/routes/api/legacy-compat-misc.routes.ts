...
legacyMiscApi.get(
  ...
  bizAuthMiddleware(),
  safeHandler("ط¬ظ„ط¨ ط§ظ„طھط­طµظٹظ„ط§طھ", async (c) => {
    ...
    if (stationId)
      conditions.push(eq(vouchers.stationId, Number.parseInt(stationId)));
    if (dateStr)
      conditions.push(sql`DATE(${vouchers.voucherDate}) = ${dateStr}`);
...
legacyMiscApi.get(
  "/collections/:id",
  safeHandler("ط¬ظ„ط¨ طھظپط§طµظٹظ„ طھط­طµظٹظ„", async (c) => {
    return c.json(
      {
        error:
          "ظ‡ط°ط§ ط§ظ„ظ…ط³ط§ط± ظ‚ط¯ظٹظ…. ط§ط³طھط®ط¯ظ… /businesses/:bizId/vouchers ط£ظˆ ط´ط§ط´ط© ط§ظ„طھط­طµظٹظ„ ط§ظ„ط¬ط¯ظٹط¯ط© ط§ظ„ظ…ط¹طھظ…ط¯ط© ط¹ظ„ظ‰ ط§ظ„ط³ظ†ط¯ط§طھ.",
      },
      410,
    );
  }),
...
legacyMiscApi.post(
  "/businesses/:bizId/collections",
  bizAuthMiddleware(),
  safeHandler("ط¥ط¶ط§ظپط© طھط­طµظٹظ„", async (c) => {
    return c.json(
      {
        error:
          "طھظ… ط¥ظٹظ‚ط§ظپ ظ‡ط°ط§ ط§ظ„ظ…ط³ط§ط±. ط§ط³طھط®ط¯ظ… /businesses/:bizId/vouchers/multi ظ„ط¥ظ†ط´ط§ط، ط³ظ†ط¯ط§طھ ط§ظ„طھط­طµظٹظ„.",
      },
      410,
    );
  }),
...
legacyMiscApi.post(
  ...
  safeHandler("ط¥ط¶ط§ظپط© طھظˆط±ظٹط¯", async (c) => {
    return c.json(
      {
        error:
          "طھظ… ط¥ظٹظ‚ط§ظپ ظ‡ط°ط§ ط§ظ„ظ…ط³ط§ط±. ط§ط³طھط®ط¯ظ… /businesses/:bizId/vouchers/multi ظ„ط¥ظ†ط´ط§ط، ط³ظ†ط¯ط§طھ ط§ظ„طھظˆط±ظٹط¯/ط§ظ„طµط±ظپ.",
      },
      410,
    );
  }),
...
legacyMiscApi.get(
  "/currencies",
  safeHandler("ط¬ظ„ط¨ ط§ظ„ط¹ظ…ظ„ط§طھ", async (c) => {
...
legacyMiscApi.get(
  ...
  safeHandler("ط¬ظ„ط¨ ط§ظ„ظ…ط±ظپظ‚ط§طھ", async (c) => {
    const entityType = c.req.param("entityType");
    const entityId = parseId(c.req.param("entityId"));
    if (!entityId)
      return c.json({ error: "ظ…ط¹ط±ظ‘ظپ ط§ظ„ظƒظٹط§ظ† ط؛ظٹط± طµط§ظ„ط­" }, 400);
    const rows = await db
      .select()
      .from(attachments)
      .where(
...
legacyMiscApi.get(
  "/stations",
  safeHandler("ط¬ظ„ط¨ ط§ظ„ظ…ط­ط·ط§طھ (legacy)", async (c) => {
...
legacyMiscApi.get(
  "/employees",
  safeHandler("ط¬ظ„ط¨ ط§ظ„ظ…ظˆط¸ظپظٹظ† (legacy)", async (c) => {
    const rows = await db
      .select({
        id: employees.id,
...
legacyMiscApi.get(
  "/accounts",
  safeHandler("ط¬ظ„ط¨ ط§ظ„ط­ط³ط§ط¨ط§طھ (legacy)", async (c) => {
    const rows = await db
      .select()
      .from(accounts)
...
legacyMiscApi.get(
  "/funds",
  safeHandler("ط¬ظ„ط¨ ط§ظ„طµظ†ط§ط¯ظٹظ‚ (legacy)", async (c) => {
    const rows = await db.select().from(funds).orderBy(funds.name);
    return c.json(rows);
  }),
);
